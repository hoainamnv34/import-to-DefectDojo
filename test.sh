...
python3 import_to_defect_dojo.py --host "http://localhost:8080" --product "WebGoat App" --engagement "Test CI" --scan "SonarQube API Import" --report "./report/gitleak-report/report.json" --is_new_import="" --token "1313c9e54a7ab10774a92ccfb448884aebbcc93f" --active="True" --test_title="Static Application Security Testing"
